...
variable_int = 32
variable_float = None      # initialiser avec une valeur float
variable_boolean = None    # initialiser avec une valeur boolean
variable_string = None     # initialiser avec un string

variable_list = None       # initialiser avec une liste
variable_dictionnaire = None   # initialiser avec une pair clef-valeur afin d'avoir un dictionnaire
